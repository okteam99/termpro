...
| OKWORK-F260826061325-Account-Menu-Settings-Panel | 把侧栏左下角从 Settings 列表改成 Login 账号位；菜单只留 Settings、About、Logout。Settings 打开全局两栏面板，承接原来的通用、语言、浏览器、密码和远程机；About 仍是独立版本卡；Logout 未登录时提示 Not signed in。本期不实现真登录。 | 2026-08-26T09:39:47Z | `OKWORK-F260826061325-Account-Menu-Settings-Panel.zip` |
